...
## Add buttons to specific places on the grid ##
...
ButtonCavity.grid(row=17, column=1)
...
## Second window, used to display the images needed by the dentist ##
